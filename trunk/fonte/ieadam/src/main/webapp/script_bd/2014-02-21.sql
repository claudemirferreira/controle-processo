...
INSERT INTO `ieadam_area` (`id_area`,`data_ultima_atualizacao`,`nome`,`situacao`,`id_nucleo`,`id_membro`) VALUES 
 (1,NULL,'AREA 1','1',1,11),
 (2,NULL,'AREA 2','1',2,12),
 (3,NULL,'AREA 3','1',2,12);
...
INSERT INTO `ieadam_membro` (`id_membro`,`cep`,`cert_casamento`,`conjuge`,`cpf`,`data_bat_espirito`,`data_batismo`,`data_cadastro`,`data_decisao`,`data_nascimento`,`data_recebimento`,`email`,`endereco`,`estado_civil`,`fatorrh`,`formacao_teologico`,`nacionalidade`,`nome`,`nome_mae`,`nome_pai`,`procedencia`,`qtde_filhos`,`rg`,`rg_orgao_emissor`,`sexo`,`situacao`,`telefone`,`titulo_eleitor`,`titulo_secao`,`titulo_zona`,`uf`,`id_congregacao`,`id_funcao`,`cidade`) VALUES 
 ...
 (3,'2','2','2','2',NULL,NULL,NULL,NULL,NULL,NULL,'2','2','SO','O+','TT','66666','CLAUDEMIR RAMOS FERREIRA','TTT','TTTT','TTTT',5,'5','5','M','1','77','77','77','77','AM',1,1,'1111'),
 (4,'3','3','3','3',NULL,NULL,NULL,NULL,NULL,NULL,'3','3','SO','O+','888','888','ELIMARCOS','88','888','888',8,'8','8','M','1','9999','999','9999','9999','AM',1,1,'7777771'),
 (5,'1',NULL,'1','11',NULL,NULL,NULL,NULL,NULL,NULL,'111','111','SO','O+','UUU','UUU','MEMBRO 4','UUU','UUU','UUU',7,'7777','777','M','1','888888','88888','888','8888','AM',1,1,'11111'),
 (6,'2','2','2','2',NULL,NULL,NULL,NULL,NULL,NULL,'2','2','SO','O+','TT','66666','MEMBRO 5','TTT','TTTT','TTTT',5,'5','5','M','1','77','77','77','77','AM',1,1,'1111'),
 (7,'3','3','3','3',NULL,NULL,NULL,NULL,NULL,NULL,'3','3','SO','O+','888','888','MEMBRO 6','88','888','888',8,'8','8','M','1','9999','999','9999','9999','AM',1,1,'7777771'),
 (8,'1',NULL,'1','11',NULL,NULL,NULL,NULL,NULL,NULL,'111','111','SO','O+','UUU','UUU','MEMBRO 7','UUU','UUU','UUU',7,'7777','777','M','1','888888','88888','888','8888','AM',1,1,'11111'),
 (9,'2','2','2','2',NULL,NULL,NULL,NULL,NULL,NULL,'2','2','SO','O+','TT','66666','MEMBRO 8','TTT','TTTT','TTTT',5,'5','5','M','1','77','77','77','77','AM',1,1,'1111'),
 (10,'3','3','3','3',NULL,NULL,NULL,NULL,NULL,NULL,'3','3','SO','O+','888','888','MEMBRO 9','88','888','888',8,'8','8','M','1','9999','999','9999','9999','AM',1,1,'7777771'),
 (11,'1',NULL,'1','11',NULL,NULL,NULL,NULL,NULL,NULL,'111','111','SO','O+','UUU','UUU','MEMBRO 10','UUU','UUU','UUU',7,'7777','777','M','1','888888','88888','888','8888','AM',1,1,'11111'),
 (12,'2','2','2','2',NULL,NULL,NULL,NULL,NULL,NULL,'2','2','SO','O+','TT','66666','MEMBRO 11','TTT','TTTT','TTTT',5,'5','5','M','1','77','77','77','77','AM',1,1,'1111'),
 (13,'3','3','3','3',NULL,NULL,NULL,NULL,NULL,NULL,'3','3','SO','O+','888','888','MEMBRO 13','88','888','888',8,'8','8','M','1','9999','999','9999','9999','AM',1,1,'7777771');
...
INSERT INTO `ieadam_nucleo` (`id_nucleo`,`data_ultima_atualizacao`,`nome`,`situacao`,`id_zona`,`id_membro`) VALUES 
 (1,NULL,'NUCLEO 1','1',1,5),
 (2,NULL,'NUCLEO 2','1',1,6),
 (3,NULL,'NUCLEO 3','1',2,7),
 (4,NULL,'NUCLEO 4','1',2,8),
 (5,NULL,'NUCLEO 5','1',3,9),
 (6,NULL,'NUCLEO 6','1',3,10);
...
INSERT INTO `ieadam_pastor` (`id_pastor`,`nome`,`id_membro`,`id_usuario`,`area`,`nucleo`,`zona`) VALUES 
 (2,'WWWW',2,1,1,1,1),
 (3,'PASTOR ZONA',3,2,0,0,1),
 (4,'PASTOR NUCLEO',10,4,0,1,0),
 (5,'PASTOR AREA',12,5,1,0,0);
...
INSERT INTO `ieadam_zona` (`id_zona`,`cd_zona_argo`,`data_ultima_atualizacao`,`nome`,`situacao`,`id_primeiro_resp`,`id_segundo_resp`) VALUES 
 (1,111,NULL,'ZONA 1','1',2,NULL),
 (2,2,NULL,'ZONA 2','1',3,NULL),
 (3,3,NULL,'ZONA 3','1',4,NULL);
